...
void CompanyUplink::Load ( FILE *file )
{
	...
	LoadLList ( (LList <UplinkObject *> *) &hw_sales,  file );
	LoadLList ( (LList <UplinkObject *> *) &sw_sales,  file );
	LoadLList ( (LList <UplinkObject *> *) &news,	   file );
