...
public:
    ...
    static void     GenerateLAN_Level0Cluster   ( LanComputer *comp, LanCluster *cluster, int x, int y, int width, int height );
    static void     GenerateLAN_Level1Cluster   ( LanComputer *comp, LanCluster *cluster, int x, int y, int width, int height );
    static void     GenerateLAN_Level2Cluster   ( LanComputer *comp, LanCluster *cluster );
    static void     GenerateLAN_Level3Cluster   ( LanComputer *comp, LanCluster *cluster );
    static void     GenerateLAN_Level4Cluster   ( LanComputer *comp, LanCluster *cluster );
    ...
    static int GenerateModem            ( LanComputer *comp, LanCluster *cluster, int x, int y, int security, char *phoneNum = NULL );
