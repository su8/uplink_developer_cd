...
public:
    ...
    static void GenerateAccessCode( char *code, char *result );
    static void GenerateAccessCode( char *name, char *code, char *result );
    static void GenerateAccessCode( int accNo, char *code, char *result );
