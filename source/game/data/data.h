...
#define		PLAYER_START_GATEWAYTYPE		0
...
#define		TICKSREQUIRED_DICTIONARYHACKER	0.2					// (Num ticks required to test 1 word)
...
const float	HACKDIFFICULTY_SECURITYMODIFIER []		=		{ 0, 2.0, 1.5, 1.2, 1.0, 1.0, 0.9, 0.7, 0.5, 0.5, 0.5 };
...
#define NUM_STARTINGSOFTWAREUPGRADES 72
