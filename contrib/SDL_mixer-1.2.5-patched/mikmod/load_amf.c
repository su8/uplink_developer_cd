...
/*==============================================================================
  ...
  $Id: load_amf.c,v 1.30 2000/02/14 22:10:21 miod Exp $
...
BOOL AMF_Load(BOOL curious)
{
	...
	for(t=0;t<32;t++) {
		if(mh->panpos[t]>64) of.panning[t]=PAN_SURROUND;
		else if(mh->panpos[t]==64) of.panning[t]=255;
		else of.panning[t]=(mh->panpos[t]+64)<<1;
	}
